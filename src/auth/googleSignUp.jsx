...
const GoogleSignUp = () => {
  ...
  return (
    <div className="flex justify-center items-center mb-2 font-[poppins]">
      <button
        onClick={googleSignUp}
        className="w-[370px] rounded-md py-2 px-2  flex justify-center items-center gap-2 border-gray-500 border-2"
      >
        <svg
