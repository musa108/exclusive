...
const Services = () => {
  return (
    <>
      <main className="flex justify-center items-center gap-8 font-[poppins] py-20">
        <section className="flex flex-col justify-center items-center">
          <div className="rounded-full bg-[#2F2E30] border-[#636363] border-4 p-2">
            <svg
          ...
          <h3 className="font-[600] text-[20px]">FREE AND FAST DELIVERY</h3>
        ...
        <section className="flex flex-col justify-center items-center">
          <div className="rounded-full bg-[#2F2E30] border-[#636363] border-4 p-2">
            <svg
              ...
              fill="none"
            >
              <g clip-path="url(#clip0_804_3534)">
                <path
              ...
              <defs>
                <clipPath id="clip0_804_3534">
                  <rect width="40" height="40" fill="white" />
                </clipPath>
              </defs>
            </svg>
          </div>
          <h3 className=" font-[600] text-[20px]">24/7 CUSTOMER SERVICE</h3>
        ...
        <section className="flex flex-col justify-center items-center">
          ...
          <h3 className=" font-[600] text-[20px]">MONEY BACK GUARANTEE</h3>
